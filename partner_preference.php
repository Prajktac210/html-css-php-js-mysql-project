...
<div class="grid_3">
  <div class="container">
   ...
   <div class="profile">
			   ...
			   <div id="myTabContent" class="tab-content">
				  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
				    <div class="tab_box">
				    	...
				    	<p><textarea name="descr" rows="5" cols="150"><?php echo isset($descr) ? $descr : ''; ?></textarea></p>
 </div>
    ...
    <td class="day_value">
        <input type="text" name="agemin" value="<?php echo isset($agemin) ? $agemin : ''; ?>">to 
        <input type="text" name ="agemax" value="<?php echo isset($agemax) ? $agemax : ''; ?>"> 
    </td>
</tr>
    ...
    <td class="day_value closed"><input type="text"  id="edit-name" name="height" value="<?php echo isset($height) ? $height : ''; ?>" size="60" maxlength="60" class="form-text">cm</td>
</tr>
