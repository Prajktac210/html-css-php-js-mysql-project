...
<div class="grid_3">
  <div class="container">
   ...
   <div class="profile">
		...
		<h2>Profile Id: <?php echo isset($profileid) ? $profileid : ''; ?></h2>
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_label"><?php echo $fname . " " .$lname; ?></td>
...
$agemin = isset($row['agemin']) ? $row['agemin'] : ''; // If 'agemin' index exists, assign its value, otherwise assign an empty string
...
<!-- Inside view_profile.php -->
<a href="delete_profile.php?id=<?php echo $user_id; ?>" onclick="return confirm('Are you sure you want to delete your profile?')">Delete Profile</a>
